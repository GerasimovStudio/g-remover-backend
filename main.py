...
app = FastAPI(title="gServices AI Engine", version="1.2.0")
...
# Мягко импортируем роутер пользователей, если он лежит в проекте
try:
...
@app.get("/")
def root():
    return {"status": "online", "service": "gServices-AI-Engine"}